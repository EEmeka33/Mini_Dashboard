...
# Generate ThorVG config.h if it doesn't exist (needed for CMake builds from fresh clone)
if(CONFIG_LV_USE_THORVG_INTERNAL)
    set(THORVG_CONFIG_H "${LVGL_ROOT_DIR}/src/libs/thorvg/config.h")
    if(NOT EXISTS ${THORVG_CONFIG_H})
        message(STATUS "Generating ThorVG config.h...")
        file(WRITE ${THORVG_CONFIG_H}
"/*
